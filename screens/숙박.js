...
export default function 숙박({navigation}){
//console.log("숙박 : " + 어디());
...
const getData = () => {
    db.collection(어디()+"/숙박/숙박").get().then((querySnapshot) => { //서울
...
return (
    <Container>
        ...
        <숙박모달 isVisible={isVisible} CloseModal={CloseModal}
                 이름={이름} 설명={설명} 주소={주소} 
                 번호={번호} 기타={기타} 순서={순서}></숙박모달>
    </Container>
);
}